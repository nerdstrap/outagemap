define(function (require) {
    ...
    map.render = function (rootElementId, width, height) {
        ...
        var path_bg = rsr.path("    M551.5,154.7l-39.3,22.5h-64.3v12.7l20.6,30.8v86.5h-18.6l-11.3,15.3h-19.8v15.1h-16v58.2H394V414h20.3v9.2h23.3v-9.6h13.7v5.9    h57.1v11.9h56V154.7H551.5z").attr({fill: 'none',stroke: '#CCEDEB',"stroke-width": '4',"stroke-linecap": 'square',"stroke-linejoin": 'round',"stroke-miterlimit": '10',parent: 'STATE_BORDERS_x2F_SERVICE_BOUNDARY','stroke-opacity': '1'}).data('id', 'path_bg');
        var path_bh = rsr.path("M551.5,154.7    l-39.3,22.5h-64.3v12.7l20.6,30.8v86.5h-18.6l-11.3,15.3h-19.8v15.1h-16v58.2H394V414h20.3v9.2h23.3v-9.6h13.7v5.9h57.1v11.9h56    V154.7H551.5z").attr({fill: 'none',stroke: '#FFFFFF',"stroke-linecap": 'square',"stroke-linejoin": 'round',"stroke-miterlimit": '10',parent: 'STATE_BORDERS_x2F_SERVICE_BOUNDARY','stroke-width': '1','stroke-opacity': '1'}).data('id', 'path_bh');
        ...
        var text_bl = rsr.text(0, 0, 'Fort Wayne').attr({fill: '#58595B',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 524.9081 257.1179").data('id', 'text_bl');
        ...
        var text_bn = rsr.text(0, 0, 'St. Joseph').attr({fill: '#58595B',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 259.3021 85.2951").data('id', 'text_bn');
        ...
        var text_bp = rsr.text(0, 0, 'South Bend').attr({fill: '#58595B',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 327.4551 171.0029").data('id', 'text_bp');
        ...
        var text_br = rsr.text(0, 0, 'Three Rivers').attr({fill: '#58595B',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 458.2037 109.1922").data('id', 'text_br');
        ...
        var text_bt = rsr.text(0, 0, 'Indianapolis').attr({fill: '#58595B',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 343.6432 454.3976").data('id', 'text_bt');
        ...
        var text_bv = rsr.text(0, 0, 'Muncie').attr({fill: '#58595B',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 459.2437 387.5075").data('id', 'text_bv');
        ...
        var text_cp = rsr.text(0, 0, 'OHIO').attr({fill: '#BBB5AF',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',"letter-spacing": '2',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 629.0815 292.7469").data('id', 'text_cp');
        ...
        var text_cr = rsr.text(0, 0, 'ILLINOIS').attr({fill: '#BBB5AF',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',"letter-spacing": '2',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 55.5516 292.7469").data('id', 'text_cr');
