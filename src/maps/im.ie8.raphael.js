define(function (require) {
    ...
    map.render = function (rootElementId, width, height) {
        ...
        var text_bl = rsr.text(0, 0, 'Fort Wayne').attr({fill: '#58595B',"font-family": "HelveticaNeue Condensed, Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 464.9081 250.1179").data('id', 'text_bl');
        ...
        var text_bn = rsr.text(0, 0, 'St. Joseph').attr({fill: '#58595B',"font-family": "HelveticaNeue Condensed, Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 289.3021 81.2951").data('id', 'text_bn');
        ...
        var text_bp = rsr.text(0, 0, 'South Bend').attr({fill: '#58595B',"font-family": "HelveticaNeue Condensed, Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 305.4551 150.0029").data('id', 'text_bp');
        ...
        var text_br = rsr.text(0, 0, 'Three Rivers').attr({fill: '#58595B',"font-family": "HelveticaNeue Condensed, Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 390.2037 102.1922").data('id', 'text_br');
        ...
        var text_bt = rsr.text(0, 0, 'Indianapolis').attr({fill: '#58595B',"font-family": "HelveticaNeue Condensed, Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 320.6432 460.3976").data('id', 'text_bt');
        ...
        var text_bv = rsr.text(0, 0, 'Muncie').attr({fill: '#58595B',"font-family": "HelveticaNeue Condensed, Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 445.2437 394.5075").data('id', 'text_bv');
