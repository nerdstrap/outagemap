define(function (require) {
    ...
    map.render = function (rootElementId, width, height) {
        ...
        var _x3C_WATER2_x3E_ = rsr.path("M744,242c-0.5,0.4-1,0.8-1.4,1.3   c-1,1.5-2,2.9-3.3,4.3s-2.4,4.9-0.9,6.4c1.1,1.1,2.6,1.6,4.1,1.9c0.5,0.1,1,0.2,1.5,0.2L744,242L744,242z").attr({ id: '_x3C_WATER2_x3E_', opacity: '0.13', fill: '#231F20', "enable-background": 'new    ', parent: 'BASE_LAYER', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', '_x3C_WATER2_x3E_');
        ...
        var _x3C_major_highway8_x3E_ = rsr.path("   M433.1,61.4c0,3.9-0.1,7.6-0.5,11.3c-0.3,3.2-0.7,6.9-0.3,10.1c0.5,3.6,3.2,5.4,4.8,8.4c0.8,1.4,1.3,2.9,2.1,4.2   c0.9,1.4,2.4,2.2,3.5,3.4c1.3,1.5,1.8,3.8,3.4,4.7").attr({ id: '_x3C_major_highway8_x3E_', fill: 'none', stroke: '#F0CD9F', "stroke-width": '2', "stroke-linecap": 'round', "stroke-linejoin": 'round', parent: 'MAJOR_HIGHWAYS_LAYER', 'stroke-opacity': '1' }).data('id', '_x3C_major_highway8_x3E_');
        var _x3C_major_highway9_x3E_ = rsr.path("   M563.4,74c-4,0-9-0.4-13,0.1c-2.1,0.3-4.2,0.5-6,1.8c-1.7,1.3-2.2,2.6-3.3,4.4c-0.9,1.5-1.7,2.3-3.4,2.9c-1.6,0.5-3.4,0.1-4.8,0.9   c-1.6,1-2.4,3-3.7,4.4c-1.8,1.9-4.1,1.9-6.7,2c-3.9,0.2-7.9-0.2-11.8,0c-2.3,0.1-4.7,0.5-6.9,1.2c-1.3,0.4-2.4,1.4-3.8,1.3   c-4.1-0.2-8.8-0.5-13-0.5c-2,0-7.5-0.7-9.1,0.6c-0.9,0.7-1.1,2.6-1.9,3.6c-1.1,1.3-2.5,2-4.1,2.7c-3.3,1.5-6.8,2.9-9.7,4.9   c-2.2,1.5-4.8,2.4-7.2,3.6").attr({ id: '_x3C_major_highway9_x3E_', fill: 'none', stroke: '#F0CD9F', "stroke-width": '2', "stroke-linecap": 'round', "stroke-linejoin": 'round', parent: 'MAJOR_HIGHWAYS_LAYER', 'stroke-opacity': '1' }).data('id', '_x3C_major_highway9_x3E_');
        var _x3C_major_highway10_x3E_ = rsr.path("   M452.8,117.4c2.7,4.6-0.4,11.1,2.1,15.6c1.2,2.3,3.8,3.1,5.4,5.1c2.3,2.8,1.2,6.2,2.3,9.4c0.5,1.6,0.3,3.4,0.7,4.9   c0.6,2.1,2.7,5.5,4.3,6.9c0.6,0.5,3.3,2.9,3.4,2.8").attr({ id: '_x3C_major_highway10_x3E_', fill: 'none', stroke: '#F0CD9F', "stroke-width": '2', "stroke-linecap": 'round', "stroke-linejoin": 'round', parent: 'MAJOR_HIGHWAYS_LAYER', 'stroke-opacity': '1' }).data('id', '_x3C_major_highway10_x3E_');
        var _x3C_major_highway11_x3E_ = rsr.path("   M447.5,117.3c0,3.4-0.1,6.3-1.2,9.5c-0.7,2.1-1.9,4.8-1,7c1.6,3.5-0.1,8-2.3,11.1c-1.2,1.6-2.4,2.6-4.2,3.6c0,0-2.7,1.3-3.7,1.9").attr({ id: '_x3C_major_highway11_x3E_', fill: 'none', stroke: '#F0CD9F', "stroke-width": '2', "stroke-linecap": 'round', "stroke-linejoin": 'round', parent: 'MAJOR_HIGHWAYS_LAYER', 'stroke-opacity': '1' }).data('id', '_x3C_major_highway11_x3E_');
        ...
        var _x3C_major_highway13_x3E__1_ = rsr.path("   M447.5,117.3c0-1.9-0.2-5.3-0.9-7.3s-1.9-3.3-2.4-5.4l1.9-0.9c0,0,1-0.3,3.3-0.4c2.1-0.1,2.7,1.1,3.9,2.6c2,2.4,4.5,6.7,3,10.1").attr({ id: '_x3C_major_highway13_x3E__1_', fill: 'none', stroke: '#F0CD9F', "stroke-width": '2', "stroke-linecap": 'round', "stroke-linejoin": 'round', parent: 'MAJOR_HIGHWAYS_LAYER', 'stroke-opacity': '1' }).data('id', '_x3C_major_highway13_x3E__1_');
        ...
        var path_dx = rsr.path("M204.6,5.6l-22,0.1l-0.1,23.7l0,0l18.3-0.3   l3.8,0.1L204.6,5.6L204.6,5.6z").attr({ fill: 'none', stroke: '#C9C79D', "stroke-linecap": 'round', "stroke-linejoin": 'round', parent: 'NON_SERVICE_COUNTIES', 'stroke-width': '1', 'stroke-opacity': '1' }).data('id', 'path_dx');
        ...
        var path_ff = rsr.path("M518.4,101.5h-6.9l-14.9,0.2l1.1,12.7   l1.1,1.9l3.8,3.5l15.6,3.2l0.2-18.4L518.4,101.5L518.4,101.5z").attr({ fill: 'none', stroke: '#C9C79D', "stroke-linecap": 'round', "stroke-linejoin": 'round', parent: 'NON_SERVICE_COUNTIES', 'stroke-width': '1', 'stroke-opacity': '1' }).data('id', 'path_ff');
        ...
        var path_fn = rsr.path("M429.5,477.8l-1.5,2    c-0.8,1.3-1.6,2.7-2.3,4").attr({ fill: 'none', stroke: '#C9C79D', "stroke-width": '4', "stroke-linecap": 'round', "stroke-linejoin": 'round', parent: 'STATE_BORDERS_x2F_SERVICE_BOUNDARY', 'stroke-opacity': '1' }).data('id', 'path_fn');
        var path_fo = rsr.path("M429.5,477.8l-1.5,2    c-0.8,1.3-1.6,2.7-2.3,4").attr({ fill: 'none', stroke: '#FFFFFF', "stroke-linecap": 'round', "stroke-linejoin": 'round', parent: 'STATE_BORDERS_x2F_SERVICE_BOUNDARY', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_fo');
        ...
        var path_fp = rsr.path("M0,159.8h31.1").attr({ fill: 'none', stroke: '#FFFFFF', "stroke-linecap": 'round', "stroke-linejoin": 'round', parent: 'STATE_BORDERS_x2F_SERVICE_BOUNDARY', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_fp');
        ...
        var path_fq = rsr.path("M547.3,0v67").attr({ fill: 'none', stroke: '#FFFFFF', "stroke-linecap": 'round', "stroke-linejoin": 'round', parent: 'STATE_BORDERS_x2F_SERVICE_BOUNDARY', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_fq');
        ...
        var path_fv = rsr.path("M565.8,98.3h136.3").attr({ fill: 'none', stroke: '#FFFFFF', parent: 'STATE_BORDERS_x2F_SERVICE_BOUNDARY', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_fv');
        ...
        var rect_ga = rsr.rect(270, 272.3, 113, 21.2).attr({ x: '270', y: '272.3', fill: 'none', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'rect_ga');
        var text_gb = rsr.text(0, 0, 'San Antonio').attr({ fill: '#595A5C', "font-family": 'HelveticaNeue', "font-size": '16', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).transform("m1 0 0 1 284.6442 283.6638").data('id', 'text_gb');
        var rect_gc = rsr.rect(202.6, 180.3, 82.7, 21.2).attr({ x: '202.6', y: '180.3', fill: 'none', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'rect_gc');
        var text_gd = rsr.text(0, 0, 'San Angelo').attr({ fill: '#595A5C', "font-family": 'HelveticaNeue', "font-size": '16', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).transform("m1 0 0 1 197.2137 191.6441").data('id', 'text_gd');
        var rect_ge = rsr.rect(232, 27, 82.7, 21.2).attr({ x: '232', y: '27', fill: 'none', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'rect_ge');
        var text_gf = rsr.text(0, 0, 'Vernon').attr({ fill: '#595A5C', "font-family": 'HelveticaNeue', "font-size": '16', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).transform("m1 0 0 1 265.1782 38.3389").data('id', 'text_gf');
        var rect_gg = rsr.rect(224.3, 120.2, 82.7, 21.2).attr({ x: '224.3', y: '120.2', fill: 'none', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'rect_gg');
        var text_gh = rsr.text(0, 0, 'Abilene').attr({ fill: '#595A5C', "font-family": 'HelveticaNeue', "font-size": '16', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).transform("m1 0 0 1 254.7561 131.5299").data('id', 'text_gh');
        var rect_gi = rsr.rect(62, 234.9, 82.7, 21.2).attr({ x: '62', y: '234.9', fill: 'none', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'rect_gi');
        var text_gj = rsr.text(0, 0, 'Alpine').attr({ fill: '#595A5C', "font-family": 'HelveticaNeue', "font-size": '16', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).transform("m1 0 0 1 100.5625 246.219").data('id', 'text_gj');
        var rect_gk = rsr.rect(510.2, 251.7, 82.7, 21.2).attr({ x: '510.2', y: '251.7', fill: 'none', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'rect_gk');
        var text_gl = rsr.text(0, 0, 'Houston').attr({ fill: '#595A5C', "font-family": 'HelveticaNeue', "font-size": '16', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).transform("m1 0 0 1 510.1692 263.0975").data('id', 'text_gl');
        var rect_gm = rsr.rect(430.8, 368.2, 106.6, 23.7).attr({ x: '430.8', y: '368.2', fill: 'none', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'rect_gm');
        var text_gn = rsr.text(0, 0, 'Corpus Christi').attr({ fill: '#595A5C', "font-family": 'HelveticaNeue', "font-size": '16', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).transform("m1 0 0 1 430.7834 379.5235").data('id', 'text_gn');
        var rect_go = rsr.rect(477.9, 340, 106.6, 23.7).attr({ x: '477.9', y: '340', fill: 'none', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'rect_go');
        var text_gp = rsr.text(0, 0, 'Victoria').attr({ fill: '#595A5C', "font-family": 'HelveticaNeue', "font-size": '16', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).transform("m1 0 0 1 477.8723 351.3956").data('id', 'text_gp');
        var rect_gq = rsr.rect(404.6, 226.7, 106.6, 23.7).attr({ x: '404.6', y: '226.7', fill: 'none', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'rect_gq');
        var text_gr = rsr.text(0, 0, 'Austin').attr({ fill: '#595A5C', "font-family": 'HelveticaNeue', "font-size": '16', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).transform("m1 0 0 1 404.5762 238.0934").data('id', 'text_gr');
        var rect_gs = rsr.rect(313.8, 457.6, 60.1, 19.3).attr({ x: '313.8', y: '457.6', fill: 'none', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'rect_gs');
        var text_gt = rsr.text(0, 0, 'McAllen').attr({ fill: '#595A5C', "font-family": 'HelveticaNeue', "font-size": '16', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).transform("m1 0 0 1 318.7253 468.969").data('id', 'text_gt');
        var rect_gu = rsr.rect(337.6, 382.2, 106.6, 23.7).attr({ x: '337.6', y: '382.2', fill: 'none', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'rect_gu');
        var text_gv = rsr.text(0, 0, 'Laredo').attr({ fill: '#595A5C', "font-family": 'HelveticaNeue', "font-size": '16', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).transform("m1 0 0 1 337.585 393.5983").data('id', 'text_gv');
        STATE_NAMES_x2F_CITIES.attr({ 'id': 'STATE_NAMES_x2F_CITIES', 'name': 'STATE_NAMES_x2F_CITIES' });
        var group_a = rsr.set();
        var path_gw = rsr.path("M154.5,246.1c-2.5,0-4.6-2.1-4.6-4.6s2.1-4.6,4.6-4.6s4.6,2.1,4.6,4.6S157,246.1,154.5,246.1z").attr({ fill: '#595A5C', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_gw');
        var path_gx = rsr.path("M154.5,238.2c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3S152.7,238.2,154.5,238.2     M154.5,235.6c-3.3,0-5.9,2.6-5.9,5.9s2.6,5.9,5.9,5.9c3.3,0,5.9-2.6,5.9-5.9S157.8,235.6,154.5,235.6L154.5,235.6z").attr({ fill: '#998776', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_gx');
        var path_gy = rsr.path("M154.5,238.2c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3S152.7,238.2,154.5,238.2     M154.5,236.2c-2.9,0-5.3,2.4-5.3,5.3s2.4,5.3,5.3,5.3c2.9,0,5.3-2.4,5.3-5.3S157.4,236.2,154.5,236.2L154.5,236.2z").attr({ fill: '#FFFFFF', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_gy');
        group_a.attr({ 'parent': 'STATE_NAMES_x2F_CITIES', 'name': 'group_a' });
        var group_b = rsr.set();
        var path_gz = rsr.path("M374.4,296.1c-2.5,0-4.6-2.1-4.6-4.6s2.1-4.6,4.6-4.6s4.6,2.1,4.6,4.6S377,296.1,374.4,296.1z").attr({ fill: '#595A5C', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_gz');
        var path_ha = rsr.path("M374.4,288.2c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3    C371.1,289.6,372.6,288.2,374.4,288.2 M374.4,285.6c-3.3,0-5.9,2.6-5.9,5.9s2.6,5.9,5.9,5.9s5.9-2.6,5.9-5.9    S377.7,285.6,374.4,285.6L374.4,285.6z").attr({ fill: '#998776', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_ha');
        var path_hb = rsr.path("M374.4,288.2c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3    C371.1,289.6,372.6,288.2,374.4,288.2 M374.4,286.2c-2.9,0-5.3,2.4-5.3,5.3s2.4,5.3,5.3,5.3s5.3-2.4,5.3-5.3    S377.4,286.2,374.4,286.2L374.4,286.2z").attr({ fill: '#FFFFFF', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hb');
        group_b.attr({ 'parent': 'STATE_NAMES_x2F_CITIES', 'name': 'group_b' });
        var group_c = rsr.set();
        var path_hc = rsr.path("M407.4,253.2c-2.5,0-4.6-2.1-4.6-4.6s2.1-4.6,4.6-4.6s4.6,2.1,4.6,4.6S410,253.2,407.4,253.2z").attr({ fill: '#595A5C', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hc');
        var path_hd = rsr.path("M407.4,245.3c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3S405.6,245.3,407.4,245.3     M407.4,242.7c-3.3,0-5.9,2.6-5.9,5.9s2.6,5.9,5.9,5.9s5.9-2.6,5.9-5.9S410.7,242.7,407.4,242.7L407.4,242.7z").attr({ fill: '#998776', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hd');
        var path_he = rsr.path("M407.4,245.3c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3S405.6,245.3,407.4,245.3     M407.4,243.3c-2.9,0-5.3,2.4-5.3,5.3s2.4,5.3,5.3,5.3s5.3-2.4,5.3-5.3S410.3,243.3,407.4,243.3L407.4,243.3z").attr({ fill: '#FFFFFF', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_he');
        group_c.attr({ 'parent': 'STATE_NAMES_x2F_CITIES', 'name': 'group_c' });
        var group_d = rsr.set();
        var path_hf = rsr.path("M439.1,330.8c-2.5,0-4.6-2.1-4.6-4.6s2.1-4.6,4.6-4.6s4.6,2.1,4.6,4.6S441.6,330.8,439.1,330.8z").attr({ fill: '#595A5C', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hf');
        var path_hg = rsr.path("M439.1,322.9c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3    C435.8,324.3,437.3,322.9,439.1,322.9 M439.1,320.3c-3.3,0-5.9,2.6-5.9,5.9s2.6,5.9,5.9,5.9s5.9-2.6,5.9-5.9    S442.4,320.3,439.1,320.3L439.1,320.3z").attr({ fill: '#998776', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hg');
        var path_hh = rsr.path("M439.1,322.9c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3    C435.8,324.3,437.3,322.9,439.1,322.9 M439.1,320.9c-2.9,0-5.3,2.4-5.3,5.3s2.4,5.3,5.3,5.3s5.3-2.4,5.3-5.3    S442,320.9,439.1,320.9L439.1,320.9z").attr({ fill: '#FFFFFF', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hh');
        group_d.attr({ 'parent': 'STATE_NAMES_x2F_CITIES', 'name': 'group_d' });
        var group_e = rsr.set();
        var path_hi = rsr.path("M510.3,275.7c-2.5,0-4.6-2.1-4.6-4.6s2.1-4.6,4.6-4.6s4.6,2.1,4.6,4.6S512.9,275.7,510.3,275.7z").attr({ fill: '#595A5C', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hi');
        var path_hj = rsr.path("M510.3,267.8c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3S508.5,267.8,510.3,267.8     M510.3,265.2c-3.3,0-5.9,2.6-5.9,5.9s2.6,5.9,5.9,5.9s5.9-2.6,5.9-5.9S513.6,265.2,510.3,265.2L510.3,265.2z").attr({ fill: '#998776', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hj');
        var path_hk = rsr.path("M510.3,267.8c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3S508.5,267.8,510.3,267.8     M510.3,265.8c-2.9,0-5.3,2.4-5.3,5.3s2.4,5.3,5.3,5.3c2.9,0,5.3-2.4,5.3-5.3S513.3,265.8,510.3,265.8L510.3,265.8z").attr({ fill: '#FFFFFF', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hk');
        group_e.attr({ 'parent': 'STATE_NAMES_x2F_CITIES', 'name': 'group_e' });
        var group_f = rsr.set();
        var path_hl = rsr.path("M421.7,378.1c-2.5,0-4.6-2.1-4.6-4.6s2.1-4.6,4.6-4.6s4.6,2.1,4.6,4.6S424.2,378.1,421.7,378.1z").attr({ fill: '#595A5C', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hl');
        var path_hm = rsr.path("M421.7,370.2c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3    C418.4,371.7,419.9,370.2,421.7,370.2 M421.7,367.6c-3.3,0-5.9,2.6-5.9,5.9s2.6,5.9,5.9,5.9s5.9-2.6,5.9-5.9    S424.9,367.6,421.7,367.6L421.7,367.6z").attr({ fill: '#998776', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hm');
        var path_hn = rsr.path("M421.7,370.2c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3    C418.4,371.7,419.9,370.2,421.7,370.2 M421.7,368.2c-2.9,0-5.3,2.4-5.3,5.3s2.4,5.3,5.3,5.3s5.3-2.4,5.3-5.3    S424.6,368.2,421.7,368.2L421.7,368.2z").attr({ fill: '#FFFFFF', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hn');
        group_f.attr({ 'parent': 'STATE_NAMES_x2F_CITIES', 'name': 'group_f' });
        var group_g = rsr.set();
        var path_ho = rsr.path("M384.3,468.7c-2.5,0-4.6-2.1-4.6-4.6s2.1-4.6,4.6-4.6s4.6,2.1,4.6,4.6S386.8,468.7,384.3,468.7z").attr({ fill: '#595A5C', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_ho');
        var path_hp = rsr.path("M384.3,460.8c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3S382.4,460.8,384.3,460.8     M384.3,458.2c-3.3,0-5.9,2.6-5.9,5.9c0,3.3,2.6,5.9,5.9,5.9s5.9-2.6,5.9-5.9C390.2,460.8,387.5,458.2,384.3,458.2L384.3,458.2z").attr({ fill: '#998776', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hp');
        var path_hq = rsr.path("M384.3,460.8c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3S382.4,460.8,384.3,460.8     M384.3,458.8c-2.9,0-5.3,2.4-5.3,5.3s2.4,5.3,5.3,5.3s5.3-2.4,5.3-5.3S387.2,458.8,384.3,458.8L384.3,458.8z").attr({ fill: '#FFFFFF', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hq');
        group_g.attr({ 'parent': 'STATE_NAMES_x2F_CITIES', 'name': 'group_g' });
        var group_h = rsr.set();
        var path_hr = rsr.path("M328.5,393.2c-2.5,0-4.6-2.1-4.6-4.6s2.1-4.6,4.6-4.6s4.6,2.1,4.6,4.6S331,393.2,328.5,393.2z").attr({ fill: '#595A5C', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hr');
        var path_hs = rsr.path("M328.5,385.3c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3S326.7,385.3,328.5,385.3     M328.5,382.7c-3.3,0-5.9,2.6-5.9,5.9c0,3.3,2.6,5.9,5.9,5.9s5.9-2.6,5.9-5.9S331.7,382.7,328.5,382.7L328.5,382.7z").attr({ fill: '#998776', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hs');
        var path_ht = rsr.path("M328.5,385.3c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3S326.7,385.3,328.5,385.3     M328.5,383.3c-2.9,0-5.3,2.4-5.3,5.3s2.4,5.3,5.3,5.3s5.3-2.4,5.3-5.3S331.4,383.3,328.5,383.3L328.5,383.3z").attr({ fill: '#FFFFFF', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_ht');
        group_h.attr({ 'parent': 'STATE_NAMES_x2F_CITIES', 'name': 'group_h' });
        var group_i = rsr.set();
        var path_hu = rsr.path("M288.3,191.9c-2.5,0-4.6-2.1-4.6-4.6s2.1-4.6,4.6-4.6s4.6,2.1,4.6,4.6S290.8,191.9,288.3,191.9z").attr({ fill: '#595A5C', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hu');
        var path_hv = rsr.path("M288.3,184c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3S286.5,184,288.3,184 M288.3,181.4    c-3.3,0-5.9,2.6-5.9,5.9s2.6,5.9,5.9,5.9s5.9-2.6,5.9-5.9C294.2,184,291.6,181.4,288.3,181.4L288.3,181.4z").attr({ fill: '#998776', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hv');
        var path_hw = rsr.path("M288.3,184c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3S286.5,184,288.3,184 M288.3,182    c-2.9,0-5.3,2.4-5.3,5.3s2.4,5.3,5.3,5.3s5.3-2.4,5.3-5.3C293.6,184.4,291.2,182,288.3,182L288.3,182z").attr({ fill: '#FFFFFF', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hw');
        group_i.attr({ 'parent': 'STATE_NAMES_x2F_CITIES', 'name': 'group_i' });
        var group_j = rsr.set();
        var path_hx = rsr.path("M317.4,132.6c-2.5,0-4.6-2.1-4.6-4.6s2.1-4.6,4.6-4.6s4.6,2.1,4.6,4.6S320,132.6,317.4,132.6z").attr({ fill: '#595A5C', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hx');
        var path_hy = rsr.path("M317.4,124.7c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3    C314.1,126.1,315.6,124.7,317.4,124.7 M317.4,122.1c-3.3,0-5.9,2.6-5.9,5.9s2.6,5.9,5.9,5.9s5.9-2.6,5.9-5.9    S320.7,122.1,317.4,122.1L317.4,122.1z").attr({ fill: '#998776', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hy');
        var path_hz = rsr.path("M317.4,124.7c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3    C314.1,126.1,315.6,124.7,317.4,124.7 M317.4,122.7c-2.9,0-5.3,2.4-5.3,5.3s2.4,5.3,5.3,5.3s5.3-2.4,5.3-5.3    C322.7,125,320.4,122.7,317.4,122.7L317.4,122.7z").attr({ fill: '#FFFFFF', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_hz');
        group_j.attr({ 'parent': 'STATE_NAMES_x2F_CITIES', 'name': 'group_j' });
        var group_k = rsr.set();
        var path_ia = rsr.path("M324.2,39.2c-2.5,0-4.6-2.1-4.6-4.6s2.1-4.6,4.6-4.6s4.6,2.1,4.6,4.6C328.8,37.2,326.7,39.2,324.2,39.2z").attr({ fill: '#595A5C', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_ia');
        var path_ib = rsr.path("M324.2,31.3c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3C320.9,32.8,322.4,31.3,324.2,31.3     M324.2,28.7c-3.3,0-5.9,2.6-5.9,5.9c0,3.3,2.6,5.9,5.9,5.9s5.9-2.6,5.9-5.9C330.1,31.4,327.5,28.7,324.2,28.7L324.2,28.7z").attr({ fill: '#998776', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_ib');
        var path_ic = rsr.path("M324.2,31.3c1.8,0,3.3,1.5,3.3,3.3s-1.5,3.3-3.3,3.3s-3.3-1.5-3.3-3.3C320.9,32.8,322.4,31.3,324.2,31.3     M324.2,29.3c-2.9,0-5.3,2.4-5.3,5.3c0,2.9,2.4,5.3,5.3,5.3s5.3-2.4,5.3-5.3S327.1,29.3,324.2,29.3L324.2,29.3z").attr({ fill: '#FFFFFF', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'path_ic');
        group_k.attr({ 'parent': 'STATE_NAMES_x2F_CITIES', 'name': 'group_k' });
        var group_l = rsr.set();
        var rect_id = rsr.rect(391.1, 22.6, 101, 17.7).attr({ x: '391.1', y: '22.6', fill: 'none', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'rect_id');
        var text_ie = rsr.text(0, 0, 'OKLAHOMA').attr({ fill: '#BCB6AF', "font-family": 'ArialMT', "font-size": '16', "letter-spacing": '2', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).transform("m1 0 0 1 392.5851 33.9757").data('id', 'text_ie');
        group_l.attr({ 'parent': 'STATE_NAMES_x2F_CITIES', 'name': 'group_l' });
        var group_m = rsr.set();
        var rect_if = rsr.rect(4.4, 107.3, 170, 28.6).attr({ x: '4.4', y: '107.3', fill: 'none', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'rect_if');
        var text_ig = rsr.text(0, 0, 'NEW MEXICO').attr({ fill: '#BCB6AF', "font-family": 'ArialMT', "font-size": '16', "letter-spacing": '2', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).transform("m1 0 0 1 33.9247 118.6183").data('id', 'text_ig');
        group_m.attr({ 'parent': 'STATE_NAMES_x2F_CITIES', 'name': 'group_m' });
        var group_n = rsr.set();
        var rect_ih = rsr.rect(81.9, 376.7, 170, 28.6).attr({ x: '81.9', y: '376.7', fill: 'none', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'rect_ih');
        var text_ii = rsr.text(0, 0, 'MEXICO').attr({ fill: '#BCB6AF', "font-family": 'ArialMT', "font-size": '16', "letter-spacing": '2', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).transform("m1 0 0 1 133.9211 388.0258").data('id', 'text_ii');
        group_n.attr({ 'parent': 'STATE_NAMES_x2F_CITIES', 'name': 'group_n' });
        var group_o = rsr.set();
        var rect_ij = rsr.rect(578.9, 58.6, 105.2, 27.6).attr({ x: '578.9', y: '58.6', fill: 'none', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'rect_ij');
        var text_ik = rsr.text(0, 0, 'ARKANSAS').attr({ fill: '#BCB6AF', "font-family": 'ArialMT', "font-size": '16', "letter-spacing": '2', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).transform("m1 0 0 1 586.5929 69.9761").data('id', 'text_ik');
        group_o.attr({ 'parent': 'STATE_NAMES_x2F_CITIES', 'name': 'group_o' });
        var group_p = rsr.set();
        var rect_il = rsr.rect(604.9, 224.8, 105.2, 27.6).attr({ x: '604.9', y: '224.8', fill: 'none', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).data('id', 'rect_il');
        var text_im = rsr.text(0, 0, 'LOUISIANA').attr({ fill: '#BCB6AF', "font-family": 'ArialMT', "font-size": '16', "letter-spacing": '2', parent: 'STATE_NAMES_x2F_CITIES', 'stroke-width': '0', 'stroke-opacity': '1' }).transform("m1 0 0 1 610.5875 236.1295").data('id', 'text_im');
