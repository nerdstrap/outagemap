define(function (require) {
    ...
    map.render = function (rootElementId, width, height) {
        ...
        var text_gf = rsr.text(0, 0, 'San Antonio').attr({fill: '#58595B',"font-family": "HelveticaNeue Condensed, Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 324.6442 288.6638").data('id', 'text_gf');
        ...
        var text_gh = rsr.text(0, 0, 'San Angelo').attr({fill: '#58595B',"font-family": "HelveticaNeue Condensed, Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 240.2137 187.6441").data('id', 'text_gh');
        ...
        var text_gj = rsr.text(0, 0, 'Vernon').attr({fill: '#58595B',"font-family": "HelveticaNeue Condensed, Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 295.1782 34.3389").data('id', 'text_gj');
        ...
        var text_gl = rsr.text(0, 0, 'Abilene').attr({fill: '#58595B',"font-family": "HelveticaNeue Condensed, Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 284.7561 126.5299").data('id', 'text_gl');
        ...
        var text_gn = rsr.text(0, 0, 'Alpine').attr({fill: '#58595B',"font-family": "HelveticaNeue Condensed, Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 127.5625 241.219").data('id', 'text_gn');
        ...
        var text_gp = rsr.text(0, 0, 'Houston').attr({fill: '#58595B',"font-family": "HelveticaNeue Condensed, Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 545.1692 270.0975").data('id', 'text_gp');
        ...
        var text_gr = rsr.text(0, 0, 'Corpus Christi').attr({fill: '#58595B',"font-family": "HelveticaNeue Condensed, Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 473.7834 374.5235").data('id', 'text_gr');
        ...
        var text_gt = rsr.text(0, 0, 'Victoria').attr({fill: '#58595B',"font-family": "HelveticaNeue Condensed, Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 474.8723 330.3956").data('id', 'text_gt');
        ...
        var text_gv = rsr.text(0, 0, 'Austin').attr({fill: '#58595B',"font-family": "HelveticaNeue Condensed, Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 435.5762 248.0934").data('id', 'text_gv');
        ...
        var text_gz = rsr.text(0, 0, 'Laredo').attr({fill: '#58595B',"font-family": "HelveticaNeue Condensed, Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 360.585 390.5983").data('id', 'text_gz');
