define(function (require) {
    ...
    map.render = function (rootElementId, width, height) {
        ...
        var _x3C_BACKGROUND_x3E_ = rsr.rect(0, 0, width, height).attr({id: '_x3C_BACKGROUND_x3E_',fill: '#EAE7D0',parent: 'BASE_LAYER','stroke-width': '0','stroke-opacity': '1'}).data('id', '_x3C_BACKGROUND_x3E_');
        ...
        var text_gf = rsr.text(0, 0, 'San Antonio').attr({fill: '#58595B',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 284.6442 283.6638").data('id', 'text_gf');
        ...
        var text_gh = rsr.text(0, 0, 'San Angelo').attr({fill: '#58595B',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 197.2137 191.6441").data('id', 'text_gh');
        ...
        var text_gj = rsr.text(0, 0, 'Vernon').attr({fill: '#58595B',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 265.1782 38.3389").data('id', 'text_gj');
        ...
        var text_gl = rsr.text(0, 0, 'Abilene').attr({fill: '#58595B',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 254.7561 131.5299").data('id', 'text_gl');
        ...
        var text_gn = rsr.text(0, 0, 'Alpine').attr({fill: '#58595B',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 100.5625 246.219").data('id', 'text_gn');
        ...
        var text_gp = rsr.text(0, 0, 'Houston').attr({fill: '#58595B',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 510.1692 263.0975").data('id', 'text_gp');
        ...
        var text_gr = rsr.text(0, 0, 'Corpus Christi').attr({fill: '#58595B',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 430.7834 379.5235").data('id', 'text_gr');
        ...
        var text_gt = rsr.text(0, 0, 'Victoria').attr({fill: '#58595B',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 477.8723 351.3956").data('id', 'text_gt');
        ...
        var text_gv = rsr.text(0, 0, 'Austin').attr({fill: '#58595B',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 404.5762 238.0934").data('id', 'text_gv');
        ...
        var text_gx = rsr.text(0, 0, 'McAllen').attr({fill: '#58595B',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 318.7253 468.969").data('id', 'text_gx');
        ...
        var text_gz = rsr.text(0, 0, 'Laredo').attr({fill: '#58595B',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 337.585 393.5983").data('id', 'text_gz');
        ...
        var text_ii = rsr.text(0, 0, 'OKLAHOMA').attr({fill: '#BBB5AF',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',"letter-spacing": '2',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 392.5851 33.9757").data('id', 'text_ii');
        ...
        var text_ik = rsr.text(0, 0, 'NEW MEXICO').attr({fill: '#BBB5AF',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',"letter-spacing": '2',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 33.9247 118.6183").data('id', 'text_ik');
        ...
        var text_im = rsr.text(0, 0, 'MEXICO').attr({fill: '#BBB5AF',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',"letter-spacing": '2',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 133.9211 388.0258").data('id', 'text_im');
        ...
        var text_io = rsr.text(0, 0, 'ARKANSAS').attr({fill: '#BBB5AF',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',"letter-spacing": '2',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 586.5929 69.9761").data('id', 'text_io');
        ...
        var text_iq = rsr.text(0, 0, 'LOUISIANA').attr({fill: '#BBB5AF',"font-family": "'HelveticaNeue Condensed', 'Helvetica', Helvetica, Arial, sans-serif","font-size": '16',"letter-spacing": '2',parent: 'STATE_NAMES_x2F_CITIES','stroke-width': '0','stroke-opacity': '1'}).transform("m1 0 0 1 610.5875 236.1295").data('id', 'text_iq');
